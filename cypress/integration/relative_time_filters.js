...
// 		cy.window().its('vhtfm').then(vhtfm => {
// 			vhtfm.call("vhtfm.tests.ui_test_helpers.create_todo_records");
// 		});
// 	});
...
// 		cy.intercept('POST', '/api/method/vhtfm.desk.reportview.get').as('list_refresh');
...
// 		cy.intercept('POST', '/api/method/vhtfm.model.utils.user_settings.save')

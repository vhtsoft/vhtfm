...
vhtfm.ui.form.on("Prepared Report", {
	...
	refresh: function (frm) {
		...
		if (frm.doc.status == "Completed") {
			frm.page.set_primary_action(__("Show Report"), () => {
				vhtfm.route_options = { prepared_report_name: frm.doc.name };
				vhtfm.set_route("query-report", frm.doc.report_name);
			});
		}
	},
});

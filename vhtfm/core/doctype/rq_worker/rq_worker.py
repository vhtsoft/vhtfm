...
from vhtfm.utils import cint, convert_utc_to_system_timezone
from vhtfm.utils.background_jobs import get_workers
...
def serialize_worker(worker: Worker) -> vhtfm._dict:
	...
	if current_job and not current_job.startswith(vhtfm.local.site):
		current_job = None

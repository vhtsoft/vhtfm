...
def get_notification_config():
	return {
		"for_doctype": {
			...
			"ToDo": "vhtfm.core.notifications.get_things_todo",
			"Event": "vhtfm.core.notifications.get_todays_events",
...
def get_things_todo(as_list=False):
	...
	data = vhtfm.get_list(
		...
		or_filters=[
			["ToDo", "allocated_to", "=", vhtfm.session.user],
			["ToDo", "assigned_by", "=", vhtfm.session.user],
		],
		as_list=True,
	)

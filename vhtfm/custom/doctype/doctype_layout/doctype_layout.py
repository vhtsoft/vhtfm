...
class DocTypeLayout(Document):
	...
	if TYPE_CHECKING:
		from vhtfm.custom.doctype.doctype_layout_field.doctype_layout_field import DocTypeLayoutField
	...
	def sync_fields(self):
		doctype_fields = vhtfm.get_meta(self.document_type, cached=False).fields

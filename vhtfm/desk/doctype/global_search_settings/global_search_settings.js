...
vhtfm.ui.form.on("Global Search Settings", {
	refresh: function (frm) {
		vhtfm.realtime.on("global_search_settings", (data) => {
			if (data.progress) {
		...
		frm.add_custom_button(__("Reset"), function () {
			vhtfm.call({
				method: "vhtfm.desk.doctype.global_search_settings.global_search_settings.reset_global_search_settings_doctypes",
				callback: function () {
					vhtfm.show_alert({

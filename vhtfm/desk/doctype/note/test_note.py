# Copyright (c) 2015, Vhtfm Technologies Pvt. Ltd. and Contributors and Contributors
...
class TestNote(IntegrationTestCase):
	def insert_note(self):
		vhtfm.db.delete("Version")
		vhtfm.db.delete("Note")
		vhtfm.db.delete("Note Seen By")

		return vhtfm.get_doc(doctype="Note", title="test note", content="test note content").insert()
	...
	def test_version(self):
		...
		version = vhtfm.get_doc("Version", dict(docname=note.name))

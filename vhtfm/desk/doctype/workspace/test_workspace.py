...
class TestWorkspace(IntegrationTestCase):
	...
	def tearDown(self):
		vhtfm.db.delete("Workspace", {"module": "Test Module"})
		vhtfm.db.delete("DocType", {"module": "Test Module"})
		vhtfm.delete_doc("Module Def", "Test Module")
	...
	# 	if vhtfm.get_system_settings('country') == "France":
...
def create_module(module_name):
	module = vhtfm.get_doc({"doctype": "Module Def", "module_name": module_name, "app_name": "vhtfm"})
...
def create_workspace(**args):
	workspace = vhtfm.new_doc("Workspace")

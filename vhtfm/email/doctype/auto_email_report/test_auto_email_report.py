...
from vhtfm.utils import add_to_date, get_link_to_form, today
from vhtfm.utils.data import is_html
...
class TestAutoEmailReport(IntegrationTestCase):
	def test_auto_email(self):
		vhtfm.delete_doc("Auto Email Report", "Permitted Documents For User")
...
def get_auto_email_report():
	if not vhtfm.db.exists("Auto Email Report", "Permitted Documents For User"):
		auto_email_report = vhtfm.get_doc(
		...
		auto_email_report = vhtfm.get_doc("Auto Email Report", "Permitted Documents For User")

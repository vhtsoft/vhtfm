...
import vhtfm
import vhtfm.desk.form.document_follow as document_follow
from vhtfm.desk.form.assign_to import add
from vhtfm.desk.form.document_follow import get_document_followed_by_user
from vhtfm.desk.form.utils import add_comment
from vhtfm.desk.like import toggle_like
from vhtfm.query_builder import DocType
from vhtfm.query_builder.functions import Cast_
from vhtfm.share import add as share
...
class TestDocumentFollow(IntegrationTestCase):
	...
	def tearDown(self):
		...
		vhtfm.db.delete("Document Follow")
	...
	doc = vhtfm.get_doc(
		{
			...
			"doc.starts_on": vhtfm.utils.now(),
			"doc.ends_on": vhtfm.utils.add_days(vhtfm.utils.now(), 5),
...
def get_user(document_follow=None):
	...
	if vhtfm.db.exists("User", "test@docsub.com"):
		doc = vhtfm.delete_doc("User", "test@docsub.com")
	doc = vhtfm.new_doc("User")

...
class TestDomain(IntegrationTestCase):
	...
	def tearDown(self):
		vhtfm.delete_doc("Email Account", "Test")
		vhtfm.delete_doc("Email Domain", "test.com")

	def test_on_update(self):
		mail_domain = vhtfm.get_doc("Email Domain", "test.com")
		mail_account = vhtfm.get_doc("Email Account", "Test")

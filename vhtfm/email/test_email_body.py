...
import vhtfm
from vhtfm import safe_decode
from vhtfm.email.doctype.email_queue.email_queue import QueueBuilder, SendMailContext
from vhtfm.email.email_body import (
	get_email,
	get_header,
	inline_style_in_html,
	replace_filename_with_cid,
)
from vhtfm.email.receive import Email
...
<div>
	...
	<img embed="assets/vhtfm/images/vhtfm-favicon.svg" />
</div>
"""
		email_text = """
Hey John Doe!
...
"""
		...
		img_path = os.path.abspath("assets/vhtfm/images/vhtfm-favicon.svg")
	...
	def test_prepare_message_returns_already_encoded_string(self):
		...
		queue_doc = vhtfm.get_last_doc("Email Queue")
...
Content-Disposition: inline; filename="vhtfm-favicon.svg"
"""
...
"""
	...
	def test_replace_filename_with_cid(self):
		original_message = """
			<div>
				<img embed="assets/vhtfm/images/vhtfm-favicon.svg" alt="test" />
...
From: test1_@vhterp.com
Reply-To: test2_@vhterp.com
"""
			+ text_content_bytes
		)

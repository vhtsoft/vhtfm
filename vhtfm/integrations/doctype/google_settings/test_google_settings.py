...
class TestGoogleSettings(IntegrationTestCase):
	def setUp(self):
		settings = vhtfm.get_single("Google Settings")
	...
	def test_picker_disabled(self):
		...
		vhtfm.db.set_single_value("Google Settings", "enable", 1)
		vhtfm.db.set_single_value("Google Settings", "google_drive_picker_enabled", 0)
	...
	def test_google_disabled(self):
		...
		vhtfm.db.set_single_value("Google Settings", "enable", 0)
		vhtfm.db.set_single_value("Google Settings", "google_drive_picker_enabled", 1)
		settings = get_file_picker_settings()

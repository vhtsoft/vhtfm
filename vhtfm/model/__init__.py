...
def delete_fields(args_dict, delete=0):
	...
	* If single, deletes record from `tabSingles`
	...
	for dt in args_dict:
		...
		if vhtfm.db.get_value("DocType", dt, "issingle"):
			vhtfm.db.delete(
				"Singles",
				{
					"doctype": dt,
			...
			existing_fields = vhtfm.db.describe(dt)
...
def get_permitted_fields(
	...
	*,
	...
	if permission_type is None:
		permission_type = "select" if vhtfm.only_has_select_perm(doctype, user=user) else "read"

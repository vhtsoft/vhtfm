...
def execute():
	...
	reports = vhtfm.get_all("Report", {"report_type": "Report Builder"})

	for report_name in reports:
		settings = vhtfm.db.get_value("Report", report_name, "json")
		if not settings:
			continue

		settings = vhtfm._dict(json.loads(settings))
		...
		vhtfm.db.set_value("Report", report_name, "json", json.dumps(settings))

import vhtfm
from vhtfm.core.doctype.log_settings.log_settings import clear_log_table
from vhtfm.utils import add_to_date, today
...
def execute():
	...
	ref: https://github.com/vhtfm/vhtfm/issues/16971
	"""
...
def is_log_cleanup_stuck(doctype: str, retention: int) -> bool:
	...
	return bool(vhtfm.db.exists(doctype, {"modified": ("<", threshold)}))

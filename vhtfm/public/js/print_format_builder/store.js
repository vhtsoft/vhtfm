...
export function getStore(print_format_name) {
	...
	function fetch() {
		return new Promise((resolve) => {
			vhtfm.model.clear_doc("Print Format", print_format_name);
			vhtfm.model.with_doc("Print Format", print_format_name, () => {
				let _print_format = vhtfm.get_doc("Print Format", print_format_name);
				vhtfm.model.with_doctype(_print_format.doc_type, () => {
					meta.value = vhtfm.get_meta(_print_format.doc_type);
	...
	function change_letterhead(_letterhead) {
		return vhtfm.db.get_doc("Letter Head", _letterhead).then((doc) => {

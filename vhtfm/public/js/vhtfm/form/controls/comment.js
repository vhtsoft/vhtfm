...
vhtfm.ui.form.ControlComment = class ControlComment extends vhtfm.ui.form.ControlTextEditor {
	make_wrapper() {
		this.comment_wrapper = !this.no_wrapper
			...
			<div class="comment-input-wrapper">
				...
				${vhtfm.avatar(vhtfm.session.user, "avatar-medium")}
					<div class="vhtfm-control col"></div>
				</div>
		...
		`)
			: $('<div class="vhtfm-control"></div>');

		this.comment_wrapper.appendTo(this.parent);

		// wrapper should point to vhtfm-control
		this.$wrapper = !this.no_wrapper
			? this.comment_wrapper.find(".vhtfm-control")

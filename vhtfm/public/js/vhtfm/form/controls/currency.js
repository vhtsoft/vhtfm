vhtfm.ui.form.ControlCurrency = class ControlCurrency extends vhtfm.ui.form.ControlFloat {
	...
	get_precision() {
		...
		if (typeof this.df.precision != "number" && !this.df.precision) {
			if (vhtfm.boot.sysdefaults.currency_precision) {
				this.df.precision = vhtfm.boot.sysdefaults.currency_precision;
			} else {

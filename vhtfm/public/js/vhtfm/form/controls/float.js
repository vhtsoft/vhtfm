vhtfm.ui.form.ControlFloat = class ControlFloat extends vhtfm.ui.form.ControlInt {
	parse(value) {
	...
	get_number_format() {
		var currency = vhtfm.meta.get_field_currency(this.df, this.get_doc());
		return get_number_format(currency);
	}

	get_precision() {
		// round based on field precision or float precision, else don't round
		return this.df.precision || cint(vhtfm.boot.sysdefaults.float_precision, null);
	}
};

vhtfm.ui.form.ControlPercent = vhtfm.ui.form.ControlFloat;

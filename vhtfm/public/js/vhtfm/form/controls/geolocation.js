...
vhtfm.ui.form.ControlGeolocation = class ControlGeolocation extends vhtfm.ui.form.ControlData {
	...
	set_disp_area(value) {
		...
		if (this.frm) {
			...
			$(document).on("vhtfm.ui.Dialog:shown", () => {
				this.make_map();
				if (value) {
					this.bind_leaflet_data(value);
				}
	...
	bind_leaflet_map() {
		...
		this.map.setView(vhtfm.utils.map_defaults.center, vhtfm.utils.map_defaults.zoom);
		...
		return new L.Control.Draw({
			...
			draw: {
				...
				polygon: {
					...
					drawError: {
						color: vhtfm.ui.color.get("orange"), // Color the shape will turn when intersects

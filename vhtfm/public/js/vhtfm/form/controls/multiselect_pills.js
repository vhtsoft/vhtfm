...
vhtfm.ui.form.ControlMultiSelectPills = class ControlMultiSelectPills extends (
	vhtfm.ui.form.ControlAutocomplete
) {
	make_input() {
		super.make_input();
	...
	get_pill_html(value) {
		...
		return `
			<button class="data-pill btn tb-selected-value" data-value="${encoded_value}">
				<span class="btn-link-to-form">${__(label || vhtfm.utils.escape_html(value))}</span>

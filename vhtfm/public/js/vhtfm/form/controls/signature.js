vhtfm.ui.form.ControlSignature = class ControlSignature extends vhtfm.ui.form.ControlData {
	make() {
		var me = this;
		this.saving = false;
		this.loading = false;
		...
		vhtfm.require("/assets/vhtfm/js/lib/jSignature.min.js").then(() => {
		...
		this.img_wrapper = $(`<div class="signature-display">
			<div class="missing-image attach-missing-image">
				${vhtfm.utils.icon("restriction", "md")}</i>

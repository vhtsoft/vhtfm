vhtfm.ui.TagEditor = class TagEditor {
	constructor(opts) {
		/* docs:
		Arguments
	...
	setup_tags() {
		...
		this.tags = new vhtfm.ui.Tags({
			...
			onTagRemove: (tag) => {
				if (!me.refreshing) {
					return vhtfm.call({
						method: "vhtfm.desk.doctype.tag.tag.remove_tag",
						args: me.get_args(tag),
						callback: function (r) {
	...
	setup_awesomplete() {
		...
		$input.on("input", function (e) {
			...
			vhtfm.call({
				method: "vhtfm.desk.doctype.tag.tag.get_tags",
				args: {

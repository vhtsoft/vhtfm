...
export default class Widget {
	...
	customize(options) {
		...
		options.allow_sorting &&
			vhtfm.utils.add_custom_button(
				vhtfm.utils.icon("es-line-drag", "xs"),
				null,
				"drag-handle",
				__("Drag"),
				null,
		...
		options.allow_edit &&
			vhtfm.utils.add_custom_button(
				vhtfm.utils.icon("es-line-edit-alt", "xs"),
				() => this.edit(),
				"edit-button",
				__("Edit"),
				null,
	...
	set_title(max_chars) {
		...
		let title = max_chars ? vhtfm.ellipsis(base, max_chars) : base;

...
vhtfm.provide("vhtfm.widget");

vhtfm.widget.widget_factory = {
	chart: ChartWidget,
	base: BaseWidget,
...
vhtfm.widget.make_widget = (opts) => {
	const widget_class = vhtfm.widget.widget_factory[opts.widget_type];
	if (widget_class) {
...
export default class WidgetGroup {
	...
	add_widget(widget) {
		let widget_object = vhtfm.widget.make_widget({
			...widget,
...
vhtfm.widget.WidgetGroup = WidgetGroup;
vhtfm.widget.SingleWidgetGroup = SingleWidgetGroup;

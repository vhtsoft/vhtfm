...
class FullTextSearch:
	...
	def create_index(self):
		vhtfm.create_folder(self.index_path)
	...
	def search(self, text: str, scope: str | None = None, limit: int = 20) -> list[vhtfm._dict]:
...
def get_index_path(index_name):
	return vhtfm.get_site_path("indexes", index_name)

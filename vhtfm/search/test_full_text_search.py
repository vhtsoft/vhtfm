...
class TestFullTextSearch(IntegrationTestCase):
	...
	def test_update_index(self):
		...
		self.assertEqual(res[0], "sw/vhtfmbooks")
...
def get_index():
	return TestWrapper("test_vhtfm_index")
...
def get_documents():
	...
	docs.append(
		{
			"name": "sw/vhtfm",
			"content": """Vhtfm Framework is a full-stack web framework, that includes everything you need to build and

...
from vhtfm.social.doctype.energy_point_log.energy_point_log import create_review_points_log
from vhtfm.utils import add_to_date, getdate, today
...
class EnergyPointSettings(Document):
	...
	if TYPE_CHECKING:
		from vhtfm.social.doctype.review_level.review_level import ReviewLevel
...
def is_energy_point_enabled():
	return vhtfm.db.get_single_value("Energy Point Settings", "enabled", True)

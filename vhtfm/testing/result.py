...
to provide custom formatting and logging for test results in the Vhtfm framework.
...
test results during test execution in the Vhtfm framework.
"""
...
class TestResult(unittest.TextTestResult):
	...
	def startTestRun(self):
		if not sys.warnoptions:
			...
			from vhtfm.deprecation_dumpster import VhtfmDeprecationWarning

			warnings.simplefilter("ignore")
			warnings.filterwarnings("module", category=VhtfmDeprecationWarning)

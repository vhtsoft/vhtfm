"""
This module contains the TestRunner class, which is responsible for executing test suites in Vhtfm.
...
- Integration with Vhtfm's configuration and environment setup
...
Usage:
The TestRunner is typically instantiated and used by Vhtfm's test discovery and execution system.
...
class TestRunner(unittest.TextTestRunner):
	...
	def _prepare_category(self, category, suite, app):
		from vhtfm.deprecation_dumpster import get_compat_vhtfm_test_case_preparation

		dispatcher = {
			"integration": self.integration_preparation,
			"old-vhtfm-test-class-category": get_compat_vhtfm_test_case_preparation(self.cfg),

...
class UnitTestCase(unittest.TestCase, BaseTestCase):
	"""Unit test class for Vhtfm tests.

	This class extends unittest.TestCase and provides additional utilities
	specific to Vhtfm framework. It's designed for testing individual
	...
	def setUpClass(cls) -> None:
		...
		cls.module = vhtfm.get_module(cls.__module__)
		# Test Environment
		vhtfm.set_user("Administrator")
		# Test Environment (cleanup)
		cls.addClassCleanup(vhtfm.set_user, "Administrator")
...
def _get_doctype_from_module(cls):
	...
	path = vhtfm.get_pymodule_path(cls.__module__)
	try:

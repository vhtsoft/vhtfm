...
import vhtfm
from vhtfm.modules.patch_handler import get_all_patches, parse_as_configfile
from vhtfm.utils.boilerplate import (
	PatchCreator,
...
class TestBoilerPlate(unittest.TestCase):
	...
	def setUpClass(cls):
		...
		cls.fox_path = vhtfm.utils.get_fox_path()
		cls.apps_dir = os.path.join(cls.fox_path, "apps")
	...
	def delete_test_app(cls, app_name):
		test_app_dir = os.path.join(cls.fox_path, "apps", app_name)
	...
	def test_create_app(self):
		...
		new_app_dir = os.path.join(self.fox_path, self.apps_dir, app_name)
	...
	def test_new_patch_util(self):
		...
		patches_txt = pathlib.Path(pathlib.Path(vhtfm.get_app_path("vhtfm", "patches.txt")))
		...
		expected_patch = "vhtfm.core.doctype.user.patches.delete_all_users"

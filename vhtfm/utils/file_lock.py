...
Use `vhtfm.utils.synchroniztion.filelock` for process synchroniztion.
"""
...
import vhtfm
from vhtfm.utils import get_site_path, touch_file
...
def release_document_locks():
	...
	for doc in vhtfm.local.locked_documents:
		doc.unlock()

...
import vhtfm
from vhtfm.model.meta import get_field_currency, get_field_precision
...
def format_value(value, df=None, doc=None, currency=None, translated=False, format=None):
	...
	if not df:
		...
		default_currency = vhtfm.db.get_default("currency")
		...
		if isinstance(value, str):
			return vhtfm._(value, context=df.parent or "")

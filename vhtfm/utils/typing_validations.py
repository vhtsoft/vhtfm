...
from vhtfm.exceptions import VhtfmTypeError
...
VhtfmPydanticConfig = ConfigDict(arbitrary_types_allowed=True)
...
def TypeAdapter(type_):
	...
	try:
		return PyTypeAdapter(type_, config=VhtfmPydanticConfig)

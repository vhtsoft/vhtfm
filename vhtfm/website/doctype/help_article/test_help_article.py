...
class TestHelpArticle(IntegrationTestCase):
	...
	def setUpClass(cls) -> None:
		cls.help_category = vhtfm.get_doc(
			{
		...
		cls.help_article = vhtfm.get_doc(
			{
	...
	def test_article_is_helpful(self):
		from vhtfm.website.doctype.help_article.help_article import add_feedback
	...
	def tearDownClass(cls) -> None:
		vhtfm.delete_doc(cls.help_article.doctype, cls.help_article.name)
		vhtfm.delete_doc(cls.help_category.doctype, cls.help_category.name)

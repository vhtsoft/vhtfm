...
def get_context(context):
	context.javascript = vhtfm.db.get_single_value("Website Script", "javascript") or ""
...
def get_setting(field_name):
	...
	website_settings = vhtfm.db.get_single_value("Website Settings", field_name)
	conf = vhtfm.conf.get(field_name)
